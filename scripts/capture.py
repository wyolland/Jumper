...
with open('/home/wyolland/Documents/cmpt-414-project/caffe/Jumper/fashion-data/input/mean_256.binaryproto', 'rb') as f:
...
net = caffe.Net('/home/wyolland/Documents/cmpt-414-project/caffe/Jumper/snapshots/deploy.prototxt',
                '/home/wyolland/Documents/cmpt-414-project/caffe/Jumper/snapshots/alexnet_transfer_iter_13000.caffemodel',
                caffe.TEST)
...
while True:
    ...
    fgmask = ForegroundBackground.apply(flipframe)
